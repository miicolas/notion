...
export function invitationEmailHtml({
  ...
  const safeUrl = encodeURI(acceptUrl);
      ...
      <table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;padding:40px">
        <tr><td>
          ...
          <p style="margin:0 0 24px;font-size:15px;color:#3f3f46;line-height:1.6">
            <strong>${safeInviter}</strong> vous invite à rejoindre
            <strong>${safeOrg}</strong> en tant que <strong>${safeRole}</strong>.
          </p>
          <table cellpadding="0" cellspacing="0" style="margin:0 0 24px">
            <tr><td align="center" style="background:#18181b;border-radius:6px;padding:12px 32px">
              <a href="${safeUrl}" style="color:#ffffff;text-decoration:none;font-size:15px;font-weight:600">
                Accepter l'invitation
              </a>
            </td></tr>
          </table>
          <p style="margin:0;font-size:13px;color:#71717a;line-height:1.5">
            Ou copiez ce lien&nbsp;: <a href="${safeUrl}" style="color:#18181b;word-break:break-all">${safeUrl}</a>
          </p>
        </td></tr>
      </table>
    </td></tr>
